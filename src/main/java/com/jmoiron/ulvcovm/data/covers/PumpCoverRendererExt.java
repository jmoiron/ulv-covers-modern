 ...
 */
public class PumpCoverRendererExt implements ICoverRenderer {

    public final static PumpCoverRendererExt INSTANCE = new PumpCoverRendererExt();
    ...
    protected PumpCoverRendererExt() {
        if (LDLib.isClient()) {
            registerEvent();
        }
    }
    ...
    public void renderCover(List<BakedQuad> quads, Direction side, RandomSource rand,
        ...
        if (side == coverBehavior.attachedSide && coverBehavior instanceof PumpCoverExt pump && modelFacing != null) {
