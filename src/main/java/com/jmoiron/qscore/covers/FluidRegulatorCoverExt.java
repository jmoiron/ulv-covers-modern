...
public class FluidRegulatorCoverExt extends PumpCoverExt {
    ...
    public FluidRegulatorCoverExt(CoverDefinition definition, ICoverable coverHolder, Direction attachedSide, int tier) {
    ...
    public static final ManagedFieldHolder MANAGED_FIELD_HOLDER = new ManagedFieldHolder(FluidRegulatorCoverExt.class, PumpCoverExt.MANAGED_FIELD_HOLDER);
